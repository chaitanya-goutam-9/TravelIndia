...
import { MapPin, Phone, Mail, Clock, Send, ChevronRight, Users, Star } from "lucide-react";
        ...
        <div className="max-w-[1200px] mx-auto px-5 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
              <h3 className="text-2xl md:text-3xl font-bold text-[#1a2b48] mb-4">Our Vision</h3>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
              <h3 className="text-2xl md:text-3xl font-bold text-[#1a2b48] mb-4">Our Mission</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
      ...
      <section className="bg-white py-14 sm:py-16">
        <div className="max-w-[1200px] mx-auto px-5 lg:px-8">
          <div className="mb-8 text-center sm:mb-10">
            <h2 className="mb-3 text-[2rem] font-bold text-[#0a1b33] sm:text-[2.2rem]">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-5 lg:gap-6">
            <a href="/location/india" className="group flex min-h-[255px] flex-col items-center justify-between border border-[#d7b16b] bg-[#f8f8f8] px-4 py-10 text-center shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
              <img
            ...
            <a href="/location/world" className="group flex min-h-[255px] flex-col items-center justify-between border border-[#d7b16b] bg-[#f8f8f8] px-4 py-10 text-center shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
              <img
                src="https://travelindiatourism.com/wp-content/uploads/2026/05/Gold-Earth-and-airplane-icon.png.webp"
                alt="International Tour"
                className="h-24 w-24 object-contain transition-transform group-hover:scale-110"
              />
              <h3 className="text-base font-bold text-[#0a1b33]">International Tour</h3>
            </a>
            <div className="group flex min-h-[255px] flex-col items-center justify-between border border-[#d7b16b] bg-[#f8f8f8] px-4 py-10 text-center shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
              <img
            ...
            <a href="/visa-services" className="group flex min-h-[255px] flex-col items-center justify-between border border-[#d7b16b] bg-[#f8f8f8] px-4 py-10 text-center shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
              <img
                src="https://travelindiatourism.com/wp-content/uploads/2026/05/Golden-passport-and-ID-card-icons.png.webp"
                alt="Visa Services"
                className="h-24 w-24 object-contain transition-transform group-hover:scale-110"
              />
              <h3 className="text-base font-bold text-[#0a1b33]">Visa Services</h3>
            </a>
            <div className="group flex min-h-[255px] flex-col items-center justify-between border border-[#d7b16b] bg-[#f8f8f8] px-4 py-10 text-center shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
              <img
                ...
                className="h-24 w-24 object-contain transition-transform group-hover:scale-110"
              />
              <h3 className="text-base font-bold text-[#0a1b33]">Honeymoon Package</h3>
            </div>
          </div>
        </div>
      </section>
